package com.postelian.backend.domain.classes.util;
...
public class GeminiAiUtil {
    ...
    public String generateResponse(String promptFilePath, com.postelian.backend.domain.classes.dto.ExamRequestDto dto) throws IOException {
